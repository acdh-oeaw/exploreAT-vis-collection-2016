                    ...
                    esClient.search(queryObject).then(function (resp) {
                        ...
                        queryObject = {
                            ...
                            esClient.search(queryObject).then(function (resp) {
                                ...
                                $('#submit-0').html(scientificNamesOptions[0]);
                                $('#submit-1').html(scientificNamesOptions[1]);
                                $('#submit-2').html(scientificNamesOptions[2]);
                                $('#submit-3').html(scientificNamesOptions[3]);
