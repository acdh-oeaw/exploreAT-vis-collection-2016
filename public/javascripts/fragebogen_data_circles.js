...
function createWords() {
  ...
  esClient.search({
    ...
    //   $.ajax({
    //       type: "GET",
    //       url: "https:\/\/statickidz.com\/scripts\/traductor\/?&source=de&target=en&q="+root.children[i].name.replace(/ /g, '%20'),
    //       dataType: "json",
    //       async: false,
    //       success: function (response) {
    //
    //         root.children[i].name = "FGBN: "+response.translation;
    //
    //         for(var j=0; j<root.children[i].children.length ; j++){
    //
    //           $.ajax({
    //               type: "GET",
    //               url: "https:\/\/statickidz.com\/scripts\/traductor\/?&source=de&target=en&q="+root.children[i].children[j].name.replace(/ /g, '%20'),
    //               dataType: "json",
    //               async: false,
    //               success: function (response) {
    //
    //                 root.children[i].children[j].name = "FRG: "+response.translation;
    //
    //                 for(var k=0; k<root.children[i].children[j].children[k].length ; k++){
    //
    //                   $.ajax({
    //                       type: "GET",
    //                       url: "https:\/\/statickidz.com\/scripts\/traductor\/?&source=de&target=en&q="+root.children[i].children[j].children[k].name.replace(/ /g, '%20'),
    //                       dataType: "json",
    //                       async: false,
    //                       success: function (response) {
    //
    //                         root.children[i].children[j].children[k].name = "LM: "+response.translation;
    //                       }
    //                     });
    //                 }
    //               }
  ...
  circle = svg.selectAll("circle")
    ...
    .enter().append("circle")
      ...
      .on("mouseover", function(d,i) {
        ...
        // if(d.type == "frage"){
        //   console.log(d.name + " -> " + d.children[0].name);
        // }
